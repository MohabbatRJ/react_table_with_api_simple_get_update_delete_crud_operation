    ...
    return (
        <div className={`${theme}`}>
            ...
            <div >
                ...
                <div className={`container mt-5 mb-5 p-4 d-flex justify-content-center ${theme == 'dark' ? 'light' : 'dark'}`}>
                    <form className='container'>
                        <div >
                            <div className="form-group">
                                <label htmlFor="formGroupExampleInput">ID</label>
                                <input type="text" disabled={true} className="form-control  w-100" id="formGroupExampleInput" placeholder="id" value={id} onChange={(e) => setId(e.target.value)} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="formGroupExampleInput2">Title</label>
                                <input type="text" className="form-control" id="formGroupExampleInput2" placeholder="Title" onChange={(e) => setTitle(e.target.value)} value={title} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="formGroupExampleInput2">Description</label>
                                <textarea type="text" className="form-control" id="formGroupExampleInput2" placeholder="description" value={description} onChange={(e) => setDescription(e.target.value)} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="formGroupExampleInput2">Price</label>
                                <input type="number" className="form-control" id="formGroupExampleInput2" placeholder="price" onChange={(e) => setPrice(e.target.value)} value={price} />
                            </div>
