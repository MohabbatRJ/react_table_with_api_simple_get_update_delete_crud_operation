    ...
    const COLUMNS = [
        ...
        },
        {
            ...
            Cell: (cell) => (
                ...
                <div>
                    <button className="bg-light p-2 my-2 rounded-circle border-white border btn-lg" onClick={() => onEdit(cell.row.values)}>✍️</button>

                    <button className="bg-light p-2 my-2 rounded-circle border-white border btn-lg" onClick={() => onDelete(cell.row.values.id)}>❌</button>
                </div>
            )
        },
    ]
    ...
    return (
        <div className={`${theme}`}>
            ...
            <div className='container mt-1' >
                ...
                <table className={`table table-bordered ${theme==='dark' ? 'light' : 'dark'}`} {...getTableProps()} >
                ...
                <div className={`container text-center mb-5 p-2 ${theme==='dark' ? 'light' : 'dark'}`}>
